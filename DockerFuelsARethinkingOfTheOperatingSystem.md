...
RancherOS, consisting of just the kernel and Docker itself, is one of the smallest micro OSes, weighing in at around 22 MB, Co-fFounder and CEO Sheng Liang said, compared to about 300 MB for VMware’s Photon.
...
“These provide additional isolation,” explained Jeffrey Snover, Microsoft distinguished engineer and lead architect, in [The New Stack](http://thenewstack.io/microsofts-lightweight-os-and-its-deep-linux-connection/). “They’re really used for things like multi-tenant services, or multi-tenant platform-as-a-service, where you’re going to be running code that might be malicious that you don’t trust.” 
...
“Kubernetes will work with Rocket and they’re working to make it work with any other container. But they want to make money on the public cloud; they want to run containers on the Google cloud. But they don’t mind giving away some of their innovation on orchestration.”
